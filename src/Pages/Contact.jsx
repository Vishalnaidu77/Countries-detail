                ...
                <form onSubmit={formSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 bg-gray-50 hover:bg-white focus:bg-white"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 bg-gray-50 hover:bg-white focus:bg-white resize-none"
                    ></textarea>
                  </div>
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Find quick answers to common questions about our country database and services.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                question: "How often is the country data updated?",
                answer: "Our country database is updated regularly with the latest information from reliable sources. We strive to keep all data current and accurate."
              },
              {
                question: "Can I use this data for commercial purposes?",
                answer: "The data is provided for educational and informational purposes. Please check our terms of service for specific usage guidelines."
              },
              {
                question: "Is there an API available?",
                answer: "We're working on providing API access to our country database. Stay tuned for updates on this feature."
              },
              {
                question: "How can I report incorrect information?",
                answer: "If you notice any inaccurate data, please contact us using the form above. We appreciate your help in maintaining data quality."
              }
            ].map((faq, index) => (
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 sm:p-12 text-white">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
